...
class BuyerListingDetailScreen extends StatefulWidget {
  ...
  @override
  State<BuyerListingDetailScreen> createState() => _BuyerListingDetailScreenState();
}
              ...
              child: Column(
                ...
                children: [
                  ...
                  GridView.count(
                    ...
                    children: [
                      _InfoTile(label: 'Origin', value: 'Kazanlak Valley'),
                      _InfoTile(label: 'Season', value: 'Summer'),
                      _InfoTile(label: 'Available', value: '${listing.availableQuantity.toStringAsFixed(0)} kg'),
                      _InfoTile(label: 'Min Threshold', value: '${listing.minThreshold.toStringAsFixed(0)} kg'),
                    ],
                  ),
                  const SizedBox(height: 16),
                  ...
                  AIInsightCard(
                    ...
                    title: 'Price Insight',
                    body: 'This price is 5% below the market average of 3.68 лв/kg for Tomatoes in Sofia.\nGood deal!',
...
final _demoListing = Listing(
  ...
  city: 'Sofia', date: DateTime.now().add(const Duration(days: 2)),
  startTime: '08:00', endTime: '14:00',
  pricePerKg: 3.50, availableQuantity: 200, minThreshold: 100,
  requestedQuantity: 75, status: 'active',
